...
return array (
  ...
  'Class name "{class}" does not match class file "{file}".' => 'Ім\ʼя класу "{class}" не співпадає із файлом класу "{file}".',
