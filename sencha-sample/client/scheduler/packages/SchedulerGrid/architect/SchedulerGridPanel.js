{
    classAlias: 'widget.schedulergrid',
...
return config;
    ...
    onCreate: function() {
        ...
        //final promise configures grid
            ...
            //establist some default values
            //these are not requied but nice to have
            me.setConfigValue("viewPreset", 'hourAndDay');
            me.setConfigValue("height", 500);
            me.setConfigValue("width", 700);
            me.setConfigValue("rowHeight", 37);
            me.setConfigValue("eventBarIconClsField", 'EventType');
            me.setConfigValue("eventBodyTemplate", '<div class="sch-event-header">{headerText}</div><div class="sch-event-footer">{footerText}</div>');
        })
    }
}