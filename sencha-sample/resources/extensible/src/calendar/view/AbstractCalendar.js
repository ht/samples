...
//        }
    ...
    setSegment: function(ddIncrement, /*private*/reload) {
        var me = this;

        if (me.fireEvent(true, me) !== false) {
            me.ddIncrement = ddIncrement;

            if (me.ownerCalendarPanel && me.ownerCalendarPanel.ddIncrement !== me.ddIncrement) {
                // Sync the owning CalendarPanel's start date directly, not via CalendarPanel.setStartDate(),
                // since that would in turn call this method again.
                me.ownerCalendarPanel.ddIncrement = me.ddIncrement;
            }

            if (me.rendered) {
                me.refresh(reload);
            }
            me.fireEvent(true, me);
        }
    },
